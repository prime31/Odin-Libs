...
Mojoshader_Render_State_Type :: enum i32 {
    Zenable,
    Fill_Mode,
    Shade_Mode,
    Zwrite_Enable,
    ...
    Local_Viewer,
    Normalize_Normals,
    Diffuse_Material_Source,
    Specular_Material_Source,
    Ambient_Material_Source,
    Emissive_Material_Source,
    Vertex_Blend,
    Clip_Plane_Enable,
    Point_Size,
    Point_Size_Min,
    ...
    Point_Scale_B,
    Point_Scale_C,
    Multi_Sample_Antialias,
    Multi_Sample_Mask,
    Patch_Edge_Style,
    Debug_Monitor_Token,
    Point_Size_Max,
    Indexed_Vertex_Blend_Enable,
    Color_Write_Enable,
    Tween_Factor,
    Blend_Op,
    Position_Degree,
    ...
    Min_Tessellation_Level,
    Max_Tessellation_Level,
    Adaptivetess_X,
    Adaptivetess_Y,
    Adaptivetess_Z,
    Adaptivetess_W,
    Enable_Adaptive_Tessellation,
    Two_Sided_Stencil_Mode,
    Ccw_Stencil_Fail,
    Ccw_Stencil_Zfail,
    Ccw_Stencil_Pass,
    Ccw_Stencil_Func,
